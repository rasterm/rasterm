...
void emitPalette(SixelOutput& output, const FastColorMapper& mapper);
void emitFullPalette(SixelOutput& output, const FastColorMapper& mapper);
void emitPalette(SixelOutput& output, const FastAdaptiveColorMapper& mapper);
